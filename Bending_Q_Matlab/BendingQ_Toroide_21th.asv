...
savePath1 = "C:\Users\Dirk\Desktop\Hongrui_Yan_Simulation\Model\Toroidal_21th\Sphere_THG_SQ1550.mph";
...
r_ = key_entry{3};
    if r_ == 1.5
        radius_list = 7 : 0.3 : 10;
    elseif r_ == 2
        radius_list = 6.5 : 0.3 : 9.5;
    elseif r_ == 2.5
        radius_list = 6 : 0.3 : 9;
    elseif r_ == 3
        radius_list = 5.5 : 0.3 : 8.5;
    else
