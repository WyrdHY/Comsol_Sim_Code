...
mphstart(2036); 
%%
modelPath1 = "C:\Users\Dirk\Desktop\Hongrui_Yan_Simulation\Model\Bending_Q\Spherical Resonator.mph";
savePath1 = "C:\Users\Dirk\Desktop\Hongrui_Yan_Simulation\Model\Bending_Q\Spherical Resonator_Saved.mph";
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if ida<500
    radius_list = [1.2,1.4,1.6,1.8,2,2.2,2.4,2.6,2.8,3,3.5,4,4.5];
else 
...
for r = radius_list
    ...
    outFolder = 'C:\Users\Dirk\Desktop\Hongrui_Yan_Simulation\Code\Toroidal_21th\pure_sphere\img';
    filename = fullfile(outFolder, info+ '.fig');
...
disp(filename);
%%
a = result_map('ida=1064');
b = result_map('ida=450');
