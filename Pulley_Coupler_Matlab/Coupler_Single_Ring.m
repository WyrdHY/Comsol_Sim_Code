    ...
    for ida = ida_list
        ...
        for width_bus = width_bus_range
            ...
            for gap_distance = gap_range
                ...
                neff = mphglobal(model2, 'real(ewfd2.neff)', 'dataset', indicator.dset);
                [~, eigs] = sort(neff, 'descend');
                top2Indices = eigs(1:2);
                
                temp1 = mphglobal(model2, '(ez2)', 'dataset', indicator.dset,'solnum',top2Indices(1));
                temp2 = mphglobal(model2, '(ez2)', 'dataset', indicator.dset,'solnum',top2Indices(2));
